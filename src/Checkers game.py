...
def rules():
    ...
    Label(labelFrame, text="Taking a Turn", bg='grey', fg='white', font=('Courier', 25, 'bold')).place(relx=0.35,
                                                                                                       rely=0.05)
    Label(labelFrame,
          text="Typically the darker color pieces moves first.Each player takes their turn by moving a piece.Pieces are always moved diagonally ",
          bg='grey', fg='white', font=('Courier', 13)).place(relx=0.02, rely=0.15)
    Label(labelFrame, text="and can be moved in the following ways: ", bg='grey', fg='white',
          font=('Courier', 13)).place(relx=0.02, rely=0.20)
    ...
    Label(labelFrame,
          text="If there is one of the opponent's pieces next to a piece and an empty space on the other side, you jump your opponent",
          bg='grey', fg='white', font=('Courier', 13)).place(relx=0.04, rely=0.30)
    Label(labelFrame,
          text="and remove their piece. You can do multiple jumps if they are lined up in the forward direction",
          bg='grey', fg='white', font=('Courier', 13)).place(relx=0.04, rely=0.35)
    Label(labelFrame, text="KING PIECES", bg='grey', fg='white', font=('Courier', 25, 'bold')).place(relx=0.35,
                                                                                                     rely=0.43)
    Label(labelFrame,
          text="The last row is called the king row. If you get a piece across the board to the opponent's king row, that piece becomes a king",
          bg='grey', fg='white', font=('Courier', 13)).place(relx=0.04, rely=0.50)
    Label(labelFrame,
          text="Another piece is placed onto that piece so it is now two pieces high. King pieces can move in both directions, forward and backward",
          bg='grey', fg='white', font=('Courier', 13)).place(relx=0.04, rely=0.55)
    Label(labelFrame,
          text="Once a piece is kinged, the player must wait until the next turn to jump out of the king row",
          bg='grey', fg='white', font=('Courier', 13)).place(relx=0.04, rely=0.60)
    Label(labelFrame, text="WINNING THE GAME", bg='grey', fg='white', font=('Courier', 25, 'bold')).place(relx=0.35,
                                                                                                          rely=0.65)
    Label(labelFrame,
          text="You win the game when the opponent has no more pieces or can't move (even if he/she still has pieces)",
          bg='grey', fg='white', font=('Courier', 13)).place(relx=0.04, rely=0.75)
    Label(labelFrame, text="If neither player can move then it is a draw or a tie.", bg='grey', fg='white',
          font=('Courier', 13)).place(relx=0.04, rely=0.80)
